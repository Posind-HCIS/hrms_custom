...
app_title = "Hrms_costom"
app_publisher = "me"
app_description = "costom_file"
...
permission_query_conditions = {
	# Batasi hasil list/query untuk dump_docs hanya pada alamat "Tidak Tersedia"
	"dump_docs": "hrms_custom.base_modul.doctype.dump_docs.dump_docs.get_permission_query_conditions",
}
